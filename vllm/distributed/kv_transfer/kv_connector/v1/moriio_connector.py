    ...
    def _read_blocks(self, 
        ...
        for layer_name,local_kv_cache_metadata in self.layer_name_to_local_kv_cache_metadata.items():
            ...
            for blkid in remote_block_ids:
                ...
                # self.nixl_wrapper.read_remote_data(transfer_size_byte,offset_v*2,offset_v*2)
                self.nixl_wrapper.read_remote_data(transfer_size_byte,offset_k*2,offset_k*2)
