...
def compress_norm_rope_store_triton(
    ...
    Args:
        ape: APE tensor [compress_ratio, coff*head_dim] (required if use_bf16_state_cache=True)
        use_bf16_state_cache: If True, add APE inside kernel instead of reading fused score+ape
    """
    if use_bf16_state_cache:
        ...
        raise NotImplementedError(
            ...
            "Use the fused HIP compressor on gfx950: VLLM_DSV4_HIP_COMPRESSOR=1"
        )
